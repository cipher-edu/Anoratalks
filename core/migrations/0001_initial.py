    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_free', models.BooleanField(default=True, help_text="Agar belgilansa, foydalanuvchilar ushbu kursga avtomatik yozilishi mumkin (agar modul premium bo'lmasa).", verbose_name='Bepul Kurs')),
            ],
            options={
                'verbose_name': 'Kurs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='modul_images/%Y/%m/', verbose_name='Rasm')),
                ('order', models.PositiveIntegerField(default=0, help_text="Modullarni ko'rsatish tartibi.", verbose_name='Tartib raqami')),
                ('is_premium', models.BooleanField(default=False, help_text='Agar belgilansa, bu modulga yozilish pullik yoki maxsus ruxsat talab qiladi.', verbose_name='Premium Modul')),
            ],
            options={
                'verbose_name': 'Modul',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Yaratilgan vaqti')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Yangilangan vaqti')),
                ('enrolled_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Yozilgan vaqti')),
                ('status', models.CharField(choices=[('enrolled', 'Yozilgan'), ('completed', 'Tugatilgan')], default='enrolled', max_length=15, verbose_name='Status')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='core.course', verbose_name='Kurs')),
            ...
            options={
                ...
                'verbose_name_plural': 'Kurslarga Yozilishlar',
